{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.708000,   7.588,50,4.371e-01,5.135e+04);
   ...
   TGraph *extLgraph = new TGraph(58,energy,extL);
   TGraph *extHgraph = new TGraph(58,energy,extH);
   ...
   extHgraph->DrawGraph(8,&extHgraph->GetX()[50],&extHgraph->GetY()[50],"L");
   TArrow *arrow1 = new TArrow(1.596e+00,1.795e+02,1.596e+00,6.069e+01,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(2.492e+00,3.963e+02,2.492e+00,1.340e+02,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(5.692e+00,1.686e+04,5.692e+00,5.699e+03,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(6.332e+00,1.457e+04,6.332e+00,4.926e+03,0.02,">");
   arrow4->Draw();
   c1->Update();
   c1->Print("sigext.pdf");
   c1->Print("sigext.eps");
